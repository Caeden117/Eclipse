...
namespace Eclipse
{
    class Items
    {
        ...
        public Item[] items = new Item[] {
            ...
            new Item("Scrap Metal", "Remains of what once was. The base of a new revolution.", true, 1.25f, new int[] { }, new int[] { }, 1),
            new Item("Bolt", "Securely holds metal in place.", true, 0.45f, new int[] { }, new int[] { }, 2),
            new Item("Metal Plate", "Stronger then its scrap counterpart.", true, 2.55f, new int[] { }, new int[] { }, 3, 2),
            new Item("Metal Rod", "A rod of metal, can be used as supports or hilts.", true, 0.4f, new int[] { }, new int[] { }, 1, 1),
